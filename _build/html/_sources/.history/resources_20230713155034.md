...
Welcome to D195! Please review our most up-to-date list of student resources to get almost everything you need. The capstone can be very similar to a combination of tasks 1 and 2 from the Intro to Data Analysis& Practical Statistics (Udacity Data Analyst nanodegree part 1/5) course you passed in fullfilment of the C749 -Intro to Data Science course. Additionally, review these   task 1,   task 2, and   task 3 examples. 
Your first step is choosing a topic.

1.	Review the Proposal (task 2) and Report (task 3) rubric requirements; review these   task 1,   task 2, and   task 3 examples. Carefully review part C of task 2 and part F of task 3. Consider an argument supportable using a statistical significance; listen to C964/D195 Statistical Significance in the WGU IT Audio series.
...
4.	Compose your Topic Approval Form using the   Topic Approval Form Template and send it to me (jim.ashe@wgu.edu). If more information is needed, I'll let you know. Use this   task 1 example as a guide to the expected detail.
5.	Submit the Topic Approval Form (signed by you and me or another CI) and Waiver to Task 1 (signed by you) simultaneously.

Let me know if you have any questions. I find emails best (and fastest) for specific questions -appointments for general discussions. Though whatever your preference is fine.
