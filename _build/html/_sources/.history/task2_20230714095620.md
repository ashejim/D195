...
<div class = "tasklist">
   ...
   <input type="checkbox"> Complete the data analysis which includes a statistical test for significance or model with a performance metric (alternatively, this can be done in task 3).
