...
The methodology is the process that the project will fill when implemented. Include specific details to adequately describe the steps that will take place to execute the project entirely. Explain how your standard methodology (such as Waterfall, ADDIE, or SDLC) will apply to the implementation of the project. 
