...
While the rubric explicitly requires "statistical significance," not all non-descriptive rigourous data analysis methods have a known probability space from which to derive a $p-\text{value}$
