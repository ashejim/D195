...
In most cases, obtaining authorization can be avoided by fabricating similiar info, masking, or removing identifying information. But if you choose to move forward using restricted information, you will need to obtain documented permissions and submit them along with a waiver form to Assessments.
