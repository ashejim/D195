...
The only ex requirement regarding your chosen data is that is it available to use and share with evaluators.  Most datasets provide a question to answer, e.g., predictions, classifications, or recommendations for which an “organizational need” can be found. 
