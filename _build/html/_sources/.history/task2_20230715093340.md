...
Though more of an initial time investment, the analysis must be done at some point. Doing it first allows task 2 to be written to known (rather than anticipated) results and makes completing task 3   
