...
The Proposal Overview section summarizes one question or organizational need that you intend to answer by collecting and analyzing a set of data.

:::{note}
Part serves as introducition, presenting a thesis (A1), providing a literature review (A3), and summarizing a problem (A), and your solution, and 
:::
