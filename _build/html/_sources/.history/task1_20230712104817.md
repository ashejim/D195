...
1. 
2. A testable research question or DA supportable organizational need.
3. A statistical test or model supporting the research question or organizational need.
4. A *specific* client and problem (you can fabricate a client whose problem needs your chosen solution.)
5. The implementation of a [hard [IT deliverable](task1:faq:hard) that help solves that problem.
