...
<div class = "tasklist">
   ...
   <input type="checkbox"> Complete the data analysis which includes a statistical test for significance or model with a performance metric (alternatively, this can be done before writing task 3).
   ...
   <input type="checkbox"> Complete C2, C3, C5, & C6. A Supporting statistical test or model is the only specific rigorous requirement in tasks 2 and 3 rubrics. With this in place, the project has the necessary foundations to pass.
