...
<div class = "tasklist">
   ...
   <input type="checkbox"> Complete D1-D5. These sections describe the data and data preparation necessary for C or other analysis. 
   
   <input type="checkbox"> Complete B1-B5. The "business plan" for your project. This will outline 
