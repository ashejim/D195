...
This part should provide a summary of your project that include the below item: 
...
You are allowed to reuse content from Task 2 as needed (where relevant, update the tense to the past as Task 3 is a conclusion report). You are allowed and encouraged to reuse any of your work. The similarity check will not check for plagiarism against your content. 
