...
This section should report the results of any statistical tests or models used to support the project. In many cases, this will repeat the plan proposed in Task 2 part C4 with the addition of the results and their interpetation.
