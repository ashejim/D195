...
Describe the implementation steps used to complete each method used for the data analysis in part F of Task 3 (see Task 2 section C2). Describe the requirements for each method and how they were verified.
