...
There is no required length (maximum or minimum), but as its an overview 5-15 minutes is typically appropriate. Multimeida presentations tools, such as Powerpoint, are not required but can help 
