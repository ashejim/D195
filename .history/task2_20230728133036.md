...
Identify (C2) and justify (C2A) each statistical test or model which will support each hypothesis given in section C1. Summarize how the method will be performed or developed. The minimum required method is one per hypothesis.  
