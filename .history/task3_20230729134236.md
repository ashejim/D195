...
:::{margin} Is reusing Task 2 content OK?
Yes, you are allowed and encouraged to reuse content from Task 2 (or any of your own professional or academic works). As Task 3 is a conclusion report of what has already passed in Task 2, it's expected that the two will overlap quite. a bit
...
You are allowed to reuse content from Task 2 as needed (where relevant, update the tense to the past as Task 3 is a conclusion report). The similarity check will not check for plagiarism against your content. This part can be thought of as s summary intended for all stakeholders.
...
If an item did not vary from Task 2, explain that there were no variances and why. You can reuse content from Task 2 as needed. The similarity check will not check for plagiarism against your content.
