...
- There is no minimum length, but it is not meant to be long (in-depth details belong in the paper). Depending on your project, approximately 5-15 minutes is a good target length.  
