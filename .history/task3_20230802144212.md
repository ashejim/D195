...
Describe the implementation steps used to complete each method listed in section E1 (and in part F below (see Task 2 section C2). Describe the requirements for each method and how they were verified.
