...
This should overlap with the content in section F (also see Task 2 part C) but with fewer technical details and excluding spercific results, e.g., you don't need to include the test metrics. 
