...
Review the [task 3 examples](resources:examples). As Task 3 mainly rewrites Task 2, but more succinctly, task 3 is typically shortet in length. However, there is no minimum page requirement, and they will assess Task 3 independently of Task 2. Don't assume they'll compare the two.  
