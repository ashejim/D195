...
Though it's for the computer science capstone which has different requirements, examples of data processing, graphing, and model development can be found here:

- [Example: Supervised Classification Model]
- []
