...
- The alpha value (denoted $\alpha$; usually 1% or 5%) that will be used to determine statistical significance (e.g., if α = .05 and p-value = .025 then the null hypothesis will be rejected and there is sufficient evidence to support the hypothesis).  
