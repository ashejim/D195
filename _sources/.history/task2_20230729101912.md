...
There is no explicit minimal complexity for either. However, the data must meet the needs of the projectFor the data there is no minimal required number of elements
