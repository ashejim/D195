...
This part discusses the current state of your data (pre-processed). Write from the assumption that the data sources has been identified, collected, and previewed, but not in 
