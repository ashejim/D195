...
- Supervised regression models with performance measured by an appropriate metric such as [mean squared error](https://scikit-learn.org/stable/modules/generated/sklearn.metrics.mean_squared_error.html) or [explained variance score]().
- Supervised regression models with performance measured by an appropriate metric such as mean squared error or explained variance score.
