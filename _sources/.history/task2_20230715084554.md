...
<div class = "tasklist">
   ...
   <input type="checkbox"> Complete C2, C3, & C5. A Supporting statistical test or model is the only specific rigorous requirement in tasks 2 and 3 rubrics. With this in place, the project has the necessary foundations to pass.
