...
There is no explicit minimal complexity for either. However, the data must meet the needs of the research questions and the method must be appropriate For the data there is no minimal required number of elements
