...
- The benchmark to which the above metric(s) will be compared to determine the success of the model(s), e.g., “If the correlation coefficient is $.6, the model will be considered successful…”  
