...
Much of Tasks 2 and 3 must align with this section. Particualry the rigorous method from part C. After investiagteing your data, you may need to adjust from what was provided in [Task 1](task1). Making changes from Task 1 is acceptable (and somewhat expected) without resubmitting Task 1. However, 
