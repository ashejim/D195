...
2. 
3. A *specific* client and problem (you can fabricate a client whose problem needs your chosen solution.)
4. The implementation of a [hard [IT deliverable](task1:faq:hard) that help solves that problem.
