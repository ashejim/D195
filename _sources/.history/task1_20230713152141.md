...
- Unsupervised models such as [clustering](https://scikit-learn.org/stable/unsupervised_learning.html#unsupervised-learning) measuring performance with a [clustering metirc](https://scikit-learn.org/stable/modules/clustering.html#clustering-performance-evaluation) such as the rand score or silhouette coefficient. 
