...
The Section C.4 of the task rubric states:
> **C4:METHODS AND METRICS TO EVALUATE STATISTICAL SIGNIFICANCE**
> *The submission thoroughly and accurately describes the methods and metrics. The description includes specific details on how the <mark>methods and metrics will evaluate statistical significance.</mark>*
