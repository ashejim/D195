...
4. Compose your Topic Approval Form using the [D195 Topic Approval Form](https://github.com/ashejim/D195/blob/main/resources/D195_Topic_Approval_Form.docx) and send it to me (jim.ashe@wgu.edu). If more information is needed, I'll let you know. Use this   task 1 example as a guide to the expected detail.
