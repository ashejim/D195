...
:::{note}
Many of the rubric requirements must align with A1. Particaulary [part C](task2:C). If you've followed the recommendation of first completing the analysis, your research question can be directly related your [hypothesis](task2:C1)  
:::
