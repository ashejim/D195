...
Welcome! For the Data Analytics and ~Management~ capstone project, you’ll propose a research question OR organizational need for which your data analysis will provide a solution. The problem, the solution, and the presentation as a final product are up to you! The capstone allows you to demonstrate the application of skills collected throughout the BSDMDA program. 
